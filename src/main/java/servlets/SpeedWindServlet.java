...
/**
 * Сервлет для отбражения данных на страце со скоростью ветра
 * @author demijolla
 */
@WebServlet(urlPatterns = {"/speedwind"})
public class SpeedWindServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        services.getWd().createWeatherSegment(dateStart, dateEnd,1);
