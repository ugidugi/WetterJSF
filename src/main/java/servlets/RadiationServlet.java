...
/**
 * Сервлет для отбражения данных на страце с солнечным излучением
 * @author demijolla
 */
@WebServlet(urlPatterns = {"/radiation"})
public class RadiationServlet extends HttpServlet {
    private String dateStart;
    private String dateEnd;
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException{ 
        RequestDispatcher dispatcher = request.getRequestDispatcher("/radiation.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        services.getWd().createWeatherSegment(dateStart, dateEnd,5);
