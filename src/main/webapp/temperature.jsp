            ...
            <script type="text/javascript">
              ...
              function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Time', 'Temeratur',{ role: 'style' }],
                    <%for(Weather weather: IndexServlet.services.getQueueList()){%>                                
                        ['<%=weather.getGrafDate()%>',  <%=weather.getTemperature()%>, '#6e9022'],
                    <%}%>
                ]);
    ...
    <body>	
        <div id='test'>
            <div id='show'>
                ...
                <div id='weatherShow'>
                    <table id='index'>                    
                        <tr><td><font>Temperatur:</font> <b><%=IndexServlet.services.getWeatherToday().getTemperature()%>°C</td></tr>
                        <tr><td style="font-size: 10pt"><font>Durchschnitt pro Tag:</font> <b><%=IndexServlet.services.getAvageWeatherPerDay().getTemperature() %> °C</td></tr>
                        <tr><td style="font-size: 10pt"><font>Maximum:</font> <%=IndexServlet.services.getWd().maxTemperature() %></td></tr>
                        <tr><td style="font-size: 10pt"><font>Minimum:</font> <%=IndexServlet.services.getWd().minTemperature() %></td></tr>
                    </table>
                    <div id="chart_div" style="width: 250px; height: 200px;margin: 0%;"></div>
                </div>
                <form action="http://localhost:8080/wetter/temperaturegraf.jsp" align='center' style="margin:15%">
        ...
        <div id='table'>
            <table id = "tableUtl"'>
                ...
                <tr><td><font>></font><a >Temperatur</a></td></tr>
            ...
            <form align='center' action='<%=request.getContextPath()%>/temperature' method='post' style='border-spacing: 5px'>
